...
public class CommandTester {
    public static void main(String[] args) {
        ...
        // where a call to run execute() on this function will call
        // off() for each device in the list
        ...
        *  To do so, DeviceButton will have method called undo
        *  Undo() will perform the opposite action that the normal
        *  Command performs. undo() needs to be added to every calss with an execute()
        * */
