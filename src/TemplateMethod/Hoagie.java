...
// It allows subclasses to override some methods
public abstract class Hoagie {
    ...
    // These are called hooks if the user wants to override these they can use abstract methods
    // when you want to force the user to override and use a hook when you want it to be optional
